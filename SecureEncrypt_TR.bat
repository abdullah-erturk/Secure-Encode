...
set "_V_SIG=8a4f0d315e10ca228e867f3b8521eb781d1758a333b6c2405bfca832642c2c21"
...
ÿ 	echo.
ÿ 	echo SecureEncrypt (AES-256 Encrypt ^& Decrypt^)
ÿ 	echo.
ÿ 	echo.
...
ÿ 	)
ÿ 	 	 	
ÿ 	if exist "C:\Windows\SecureEncrypt.cmd" (
ÿ 	 	echo.
ÿ 	 	echo.
...
ÿ 	 	 	echo.
		...
		if !errorlevel! equ 1 (
			echo.
			echo Ykleniyor...
			reg delete "HKEY_CLASSES_ROOT\*\shell\SecureEncode" /f 2>nul
			del /f /q C:\Windows\SecureEncrypt.cmd 2>nul
			copy /y "%~f0" "C:\Windows\SecureEncrypt.cmd" >nul
			reg add "HKCR\*\shell\SecureEncrypt" /ve /d "Dosyay žifrele (Gvenli Kodlama AES-256)" /f >nul
